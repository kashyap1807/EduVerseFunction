...
namespace EduVerseFunction
{
    public class VideoRequestTrigger
    {
        ...
        private EduVerseDbContext GetDbContext()
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<EduVerseDbContext>();
            optionsBuilder.UseSqlServer(connectionString);

            var onlineCourseDbContext = new EduVerseDbContext(optionsBuilder.Options);
